...
namespace Sepes.RestApi.IntegrationTests.Setup.Scenarios
{
    public class MockedAzureServiceSets : IMockServicesForScenarioProvider
    {
        public void RegisterServices(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.SwapTransient<IAzureNetworkSecurityGroupRuleService>(provider => AzureNetworkSecurityGroupMockServiceFactory.CreateBasicForCreate().Object);
