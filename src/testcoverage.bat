...
@REM dotnet test .\Sepes.RestApi.IntegrationTests\ --collect:"XPlat Code Coverage" --settings .\Sepes.RestApi.IntegrationTests\integrationtests.runsettings
@REM tools\reportgenerator.exe -reports:Sepes.RestApi.IntegrationTests/TestResults/**/coverage.cobertura.xml -targetdir:./CodeCoverage/IntegrationTests -reporttypes:HtmlSummary -title:"Integration Tests"
...
@REM start chrome ./CodeCoverage/IntegrationTests/summary.htm
@REM start chrome ./CodeCoverage/Combined/summary.htm
pause