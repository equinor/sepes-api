...
namespace Sepes.Infrastructure.Service.Interface
{
    public interface ICloudResourceOperationCreateService
    {
        ...
        Task<CloudResourceOperationDto> CreateUpdateOperationAsync(int sandboxResourceId, string operationType = CloudResourceOperationType.UPDATE, int dependsOn = 0, string batchId = null);
