...
//{
//    public class AzureVmSizeService : AzureApiServiceBase, IAzureVmSizeService
//    {
//        public AzureVmSizeService(IConfiguration config, ILogger<AzureVmSizeService> logger, ITokenAcquisition tokenAcquisition)
//            : base(config, logger, tokenAcquisition)
//        {

//        }
        
//        public async Task<List<VmSizeDto>> GetAvailableSizesAsync(string region, CancellationToken cancellationToken = default)
//        {
...
//        {
//            var imagesUrl = $"https://management.azure.com/subscriptions/{_subscriptionId}/providers/Microsoft.Compute/sizes/{region}/publishers/{publisher}/artifacttypes/vmimage/offers/{offer}/skus/{skus}/versions?api-version=2020-06-01";
