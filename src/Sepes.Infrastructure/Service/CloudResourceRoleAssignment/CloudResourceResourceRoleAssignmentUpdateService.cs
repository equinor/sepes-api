...
{
    public class CloudResourceResourceRoleAssignmentUpdateService : CloudResourceRoleAssignmentServiceBase, ICloudResourceRoleAssignmentUpdateService
    {
        public CloudResourceResourceRoleAssignmentUpdateService(
            SepesDbContext db,
            IMapper mapper,
