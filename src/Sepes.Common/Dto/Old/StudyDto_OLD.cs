...
//        public StudyDto_OLD(string studyName, int studyId, IEnumerable<PodDto> pods, IEnumerable<UserDto> sponsors, 
...
//        public StudyDto_OLD(string studyName, int studyId, IEnumerable<PodDto> pods = null) : 
...
//        public StudyDto_OLD ReplacePods(IEnumerable<PodDto> newPods)
//        {
//            return new StudyDto_OLD(studyName, studyId, newPods, sponsors, suppliers, datasets, archived);
//        }
        
//        public override bool Equals(object obj)
//        {
//            return obj is StudyDto_OLD study &&
